        ...
        <div class="container">
            <div class="row">
                <div class="col-md-6 text-center text-md-start mb-3 mb-md-0">
                    &copy; <a class="fw-medium text-light" href="<?= site_url(); ?>">Irescouk</a>, All Right Reserved.
                </div>
                <div class="col-md-6 text-center text-md-end">
                    Designe and Developed By <a class="fw-medium text-light" href="http://curve360solutions.com">Curve360Solutions</a>
                </div>
            </div>
        </div>
    </div>
